...
### RHEL/CentOS
Scripts designed for RHEL-based distributions (RHEL, CentOS, AlmaLinux, Rocky Linux).  
Example: system info, node health checks, firewall setup.

### Ubuntu/Debian
Scripts tailored for Debian-based distributions.  
Example: system info, monitoring setup, network checks.

### Multi-Platform
Scripts compatible with multiple Linux distributions.  
Example: node log parsing, automated backups, security checks.
